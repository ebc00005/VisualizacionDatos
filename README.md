# PEC 2 - Visualización de Datos (UOC)

Este proyecto contiene las tres visualizaciones desarrolladas por **Eloísa** para la PEC 2 de la asignatura *Visualización de Datos* del Máster en Ciencia de Datos (UOC).
